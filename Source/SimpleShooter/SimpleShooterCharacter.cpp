...
ASimpleShooterCharacter::ASimpleShooterCharacter()
{
	...
	CameraBoom->SetUsingAbsoluteRotation(false); // 'true' will set the Camera Boom to rotate independently from its parent
...
void ASimpleShooterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Shooting
		EnhancedInputComponent->BindAction(ShootAction, ETriggerEvent::Triggered, this, &ASimpleShooterCharacter::PlayerShoot);
	}
	else
	{
...
void ASimpleShooterCharacter::PlayerShoot(const FInputActionValue& Value)
{
	Gun->PullTrigger();
}

void ASimpleShooterCharacter::AIShoot()
{
	Gun->PullTrigger();
}
